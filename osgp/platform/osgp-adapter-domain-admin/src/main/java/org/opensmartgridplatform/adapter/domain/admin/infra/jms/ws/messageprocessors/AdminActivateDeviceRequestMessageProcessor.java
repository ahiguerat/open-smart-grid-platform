 ...
 */
@Component
public class AdminActivateDeviceRequestMessageProcessor extends BaseMessageProcessor {
    /**
    ...
    public AdminActivateDeviceRequestMessageProcessor(
            ...
            @Qualifier("domainAdminInboundWebServiceRequestsMessageProcessorMap") final MessageProcessorMap messageProcessorMap) {
        super(responseMessageSender, messageProcessorMap, MessageType.ACTIVATE_DEVICE, ComponentType.DOMAIN_ADMIN);
    }
    ...
    public void processMessage(final ObjectMessage message) {
        ...
        try {
            ...
            final String ipAddress = (String) dataObject;
            this.deviceManagementService.activateDevice(organisationIdentification, deviceIdentification, correlationUid,

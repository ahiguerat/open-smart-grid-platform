...
public class SoapRequestHelper {
	...
	@Value("${web.service.template.default.uri.common.firmwaremanagement}")
	private String coreWebServicefirmwareManagementUri;
	
	@Value("${web.service.template.default.uri.common.deviceinstallation}")
	private String coreWebServiceDeviceInstallationManagementUri;
	
	@Value("${web.service.template.default.uri.common.devicemanagement}")
	private String coreWebServiceDeviceManagementUri;
	...
	/**
	 * Helper function to create a web service template to handle soap requests for
	 * the Admin domain
	 *
	 ...
	 * @return WebServiceTemplate
	 */
	public WebServiceTemplate createCoreRequest() {
		this.initMarshaller("org.opensmartgridplatform.adapter.ws.schema.core.firmwaremanagement");		
		final String uri = this.baseUri + this.coreWebServicefirmwareManagementUri;
	...
	/**
	 * Helper function to create a web service template to handle soap requests for
	 * the Core DeviceInstallation domain 
	 *
	 * @return WebServiceTemplate
	 */
	public WebServiceTemplate createCoreDeviceInstallationRequest() {
		this.initMarshaller("org.opensmartgridplatform.adapter.ws.schema.core.deviceinstallation");				
		final String uri = this.baseUri + this.coreWebServiceDeviceInstallationManagementUri;
		final WebServiceTemplate webServiceTemplate = new WebServiceTemplate(this.messageFactory);
		webServiceTemplate.setDefaultUri(uri);
		webServiceTemplate.setMarshaller(this.marshaller);
		webServiceTemplate.setUnmarshaller(this.marshaller);
	...
	/**
	 * Helper function to create a web service template to handle soap requests for
	 * the Core DeviceManagement domain 
	 *
	 * @return WebServiceTemplate
	 */
	public WebServiceTemplate createCoreDeviceManagementRequest() {
		this.initMarshaller("org.opensmartgridplatform.adapter.ws.schema.core.devicemanagement");				
		final String uri = this.baseUri + this.coreWebServiceDeviceInstallationManagementUri;
		final WebServiceTemplate webServiceTemplate = new WebServiceTemplate(this.messageFactory);
		webServiceTemplate.setDefaultUri(uri);
		webServiceTemplate.setMarshaller(this.marshaller);
